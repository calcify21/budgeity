...
const WalletActionModal: React.FC<Props> = ({ isOpen, walletId, onClose }) => {
  const {
    wallets,
    transactions,
        ...
        <div className="fixed inset-0 z-[60] overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4">
            ...
            <MotionDiv
              ...
              className="relative w-full sm:max-w-lg bg-white dark:bg-zinc-900 sm:rounded-[2.5rem] rounded-t-[2.5rem] shadow-2xl overflow-hidden border border-slate-200 dark:border-white/10 flex flex-col max-h-[90vh] z-10 p-8"
            >
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold flex items-center gap-2">
                  <AlertTriangle className="text-amber-500" /> Manage Wallet
                  Deletion
                </h2>
                <button
                  onClick={onClose}
              ...
              <div className="overflow-y-auto flex-1 custom-scrollbar">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-500 pl-11">
                      Delete wallet and all its {txCount} transactions. Cannot
                      be undone.
                    </p>
                    ...
                    {action === "delete" && (
                      ...
                      >
                        <div className="bg-rose-100 dark:bg-rose-900/30 p-3 rounded-xl flex items-start gap-2 text-rose-700 dark:text-rose-300 text-xs mb-3">
                          ...
                          <span>
                            Warning: This will remove all income, expense, and
                            transfer records associated with{" "}
